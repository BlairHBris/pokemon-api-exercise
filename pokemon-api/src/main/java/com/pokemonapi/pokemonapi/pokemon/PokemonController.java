...
import com.pokemonapi.pokemonapi.exception.ResourceNotFoundException;
...
public class PokemonController {
  ...
  private Map<String, Iterable<Pokemon>> createHashPlural(Iterable<Pokemon> someResources){
